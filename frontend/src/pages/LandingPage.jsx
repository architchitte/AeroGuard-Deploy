...
export default function LandingPage() {
    ...
    const handleLaunch = () => {
        navigate("/dashboard", { state: { selectedLocation } });
    };
        ...
        <div className="bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 min-h-screen">
            ...
            >
                ...
                >
                    ...
                    {/* Heatmap Container */}
                    <div className="relative w-full h-[600px] md:h-[750px] lg:h-[850px] rounded-[3rem] border border-white/10 bg-slate-900/50 overflow-hidden shadow-2xl ring-1 ring-white/5">
                        <PollutionHeatmap
